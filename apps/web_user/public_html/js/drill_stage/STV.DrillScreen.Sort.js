            ...
            function dataAnswerField(config) {
                ...
                if (config.answers) {
                    ...
                    _.each(config.answers, function (v) {
                        if (v.image_url != null) {
                            ansField += '<div class="jqselection-selectable dr-box-img" data-text="' + v.correct + '"><img src="/drill_images/' + v.image_url + '" alt=""></div>';
                        } else {
                            ansField += '<div class="jqselection-selectable" data-text="' + v.correct + '"><span class="dr-box">' + v.text + '</span></div>';
                        }
                    });
                    ansField += '</div></div>';
                }
