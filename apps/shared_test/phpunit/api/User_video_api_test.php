 ...
 */
class User_video_api_test extends CIUnit_TestCase
{
    ...
    public function setUp()
    {
        ...
        // Load API
        $this->CI->load->library("API/User_video_api");

        // Create object api
        $this->api =& $this->CI->user_video_api;
    ...
    /**
     * Test function get_progressing
     * SPEC UV-010
     * @dataProvider provider_get_progressing
     * @group video_get_progressing
     */
    public function test_get_progressing($params_api)
    {
        // Create data
     ...
     * TEST for all case
     */
    public function provider_get_progressing()
    {
        return [
            [['flag' => 'bad_request', 'not_login'=> 12]],
