...
/**
 * Test Video_textbook_api
 *
 * @author dung.nguyen@interest-marketing
 */
class Video_textbook_api_test extends CIUnit_TestCase
{
    ...
    public function setUp()
    {
        ...
        // Load API
        $this->CI->load->library("API/Video_textbook_api");

        // Create object api
        $this->api =& $this->CI->video_textbook_api;
    ...
    /**
     * Test function get_chapter
     * SPEC TB-021
     * @dataProvider provider_get_chapter
     * @group video_textbook_get_chapter
     */
    public function test_get_chapter($params_api)
    {
        // Create data
        ...
        // Call API
       if (!isset($params_api['chapter_name'])) {

            $params_api['chapter_name'] = $res_textbook_content->chapter_name;;
        }
        ...
        $res = $this->api->get_chapter($params_api);
     ...
     * TEST for all case
     */
    public function provider_get_chapter()
    {
        return [
            [['flag' => 'invalid_params', 'textbook_id'=> 'textbook_id' ]],
    ...
    {
        return [
          //  [['flag' => 'invalid_params', 'grade_id'=> '', 'subject_id' => '' ]],
    ...
    /**
     * Test function get_most_popular
     * SPEC TB-026
     * @dataProvider provider_get_most_popular
     * @group video_textbook_get_most_popular
     */
    public function test_get_most_popular($params_api)
    {
        // Create data
        $this->user = new User_builder();
        $p_user['id'] = 'tester';
        ...
        $res = $this->api->get_most_popular($params_api);
     ...
     * TEST for all case
     */
    public function provider_get_most_popular()
    {
        return [
            [['flag' => 'invalid_params', 'subject_id' => '' ]],
            [['flag' => 'invalid_params', 'subject_id' => 'text' ]],
