 ...
 */
class Promotion_api_test extends CIUnit_TestCase
{
    ...
    public function setUp()
    {
        ...
        // Load API
        $this->CI->load->library("API/Promotion_api");

        // Create object api
        $this->api =& $this->CI->promotion_api;
    ...
    public function test_search_users($params_api)
    {
        ...
        $p_user2['promotion_code'] = 'promotion_code';
        $p_user2['id'] = 'tester2';
