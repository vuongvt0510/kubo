...
// for email
$config['driver'] = 'email';
$config['from'] = array("noreplay@school-tv.jp", "Error notifier");
$config['to'] = array('nguyentc@nal.vn', 'khanhlq@nal.vn', 'diephq@nal.vn', 'duytt@nal.vn');
