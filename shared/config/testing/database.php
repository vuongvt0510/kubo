...
$db['master']['hostname'] = 'db03.test.interest-marketing.local';
$db['master']['username'] = 'schooltv';
$db['master']['password'] = 'schooltv';
$db['master']['database'] = DB_MAIN;
...
$db['slave']['hostname'] = 'db03.test.interest-marketing.local';
$db['slave']['username'] = 'schooltv';
$db['slave']['password'] = 'schooltv';
$db['slave']['database'] = DB_MAIN;
