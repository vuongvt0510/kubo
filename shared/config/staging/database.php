...
$db['master']['hostname'] = 'staging-schooltv.cmrzfeqoudsx.ap-northeast-1.rds.amazonaws.com';
$db['master']['username'] = 'schooltv';
$db['master']['password'] = 'schooltv';
$db['master']['database'] = 'schooltv_main';
$db['master']['dbdriver'] = 'mysqli';
$db['master']['dbprefix'] = '';
$db['master']['pconnect'] = FALSE;
$db['master']['db_debug'] = FALSE;
$db['master']['db_exception'] = TRUE;
...
$db['slave']['hostname'] = 'staging-schooltv.cmrzfeqoudsx.ap-northeast-1.rds.amazonaws.com';
$db['slave']['username'] = 'schooltv';
$db['slave']['password'] = 'schooltv';
$db['slave']['database'] = 'schooltv_main';
$db['slave']['dbdriver'] = 'mysqli';
$db['slave']['dbprefix'] = '';
$db['slave']['pconnect'] = FALSE;
$db['slave']['db_debug'] = FALSE;
$db['slave']['db_exception'] = TRUE;
