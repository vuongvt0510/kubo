...
require_once CIUPATH . 'libraries/CIUnitApiTestCase.php';
require_once CIUPATH . 'libraries/CIUnitControllerTestCase.php';
require_once CIUPATH . 'libraries/CIUnitBuilder.php';

if (file_exists(SELF . 'assets/autoload.php')) {
    require_once SELF . 'assets/autoload.php';
}
    ...
    public static function &set_controller($controller = 'CI_Controller', $path=FALSE)
    {
        ...
        */
        ...
        else
        {
            ...
            self::$current->router->set_class($controller_name);
...
//        var_dump(self::$controller); die();
    ...
    */
    ...
    public static function set_redirect($uri, $method, $http_response_code)
    {
        self::$redirect = array(
            'uri' => $uri,
            'method' => $method,
...
//=== and off we go ===
$CI = &set_controller('APP_Controller', SHAREDPATH . 'core/');
