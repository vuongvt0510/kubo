...
*/
    function &load_class($class, $directory = 'libraries', $prefix = 'CI_')
    {
        ...
        //Customized for IM add SHAREDPATH
        foreach (array(BASEPATH, SHAREDPATH, APPPATH, CIUPATH) as $path)
        {
...
if (!function_exists('redirect'))
{
    ...
    {
        CIUnit::set_redirect($uri, $method, $http_response_code);
    }
}
